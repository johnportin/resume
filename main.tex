...
\newcommand{\resumeEduDegreeEntry}[2]{
  \vspace{-1pt}\item
    \begin{tabular*}{0.97\textwidth}{l@{\extracolsep{\fill}}r}
      \hspace{1em} #1 & #2 \\
    \end{tabular*}\vspace{-5pt}
...
\newcommand{\resumeCourseEntry}[1]{
  \vspace{-1pt}\item
      \hspace{1em} \textbf{Courses}: \textit{#1} \\
}
...
\newcommand{\resumeHeadingEntry}[1]{
  \vspace{-1pt}
    \item{
      \textbf{#1} 
    } \vspace{-5pt}
...
%-------------------------------------------
\section{Objective}
    \directlua{printObjective("_data/obj.json")}
...
% Print Projects
%-------------------------------------------
\section{\href{https://github.com/johnportin}{Software Projects}}
  \resumeSubHeadingListStart
    \directlua{printBulletedEntry("_data/proj.json")}
  \resumeSubHeadingListEnd
...
\section{Research Projects}
  \resumeSubHeadingListStart
    \directlua{printBulletedEntry("_data/research.json")}
  \resumeSubHeadingListEnd
